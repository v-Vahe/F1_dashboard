...
from sql_utils import (df_to_sql, get_identity_tables, set_identity_insert_on, set_identity_insert_off, table_exists, dispose_engine)


with open('database/ordered_tables_list.txt', 'r') as f:
